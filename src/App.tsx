    ...
    <div className="min-h-screen bg-ink-900 text-white selection:bg-gold-500 selection:text-ink-900">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-xl tracking-tight">
                Impulso<span className="text-gold-500">Latino</span>
              </span>
            </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-gold-500 text-sm font-medium mb-6">
              <span className="w-2 h-2 rounded-full bg-gold-500 animate-pulse"></span>
              Agencia de Marketing Digital para Latinos en USA
            </div>

            <h1 className="text-5xl lg:text-7xl font-display font-bold leading-[1.1] tracking-tight mb-6">
              Consigue más clientes para tu negocio sin depender del{" "}
            ...
            <p className="text-lg lg:text-xl text-gray-400 mb-10 max-w-2xl leading-relaxed">
              Ayudamos a dueños de negocios latinos en Estados Unidos a crecer,
              tener estabilidad y aumentar sus ingresos con estrategias de
              marketing digital que sí funcionan.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400 text-lg">
              Sabemos lo frustrante que es trabajar duro en tu negocio y no ver
              el crecimiento que mereces.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl lg:text-5xl font-display font-bold mb-6 leading-tight">
                Es hora de tomar el control de tu{" "}
                <span className="text-gold-500">crecimiento</span>.
              </h2>
              <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                Nosotros somos la agencia de marketing digital para latinos en
                USA que entiende tu negocio y habla tu idioma.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl lg:text-5xl font-display font-bold mb-6">
              ¿Cómo te ayudamos a conseguir clientes en USA?
            </h2>
            <p className="text-gray-400 text-lg">
              Servicios diseñados específicamente para negocios locales y de
              servicios.
            </p>
          </div>
      ...
      <section id="proceso" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl lg:text-5xl font-display font-bold mb-6">
              Nuestro proceso para hacer crecer tu negocio
            </h2>
            <p className="text-gray-400 text-lg">
              Un sistema claro, sin tecnicismos y enfocado en resultados.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-ink-800/80 mb-10 font-medium">
                No vendemos "marketing", vendemos el crecimiento y la
                tranquilidad que tu negocio necesita.
              </p>
              ...
              <div className="bg-ink-900 text-white p-8 rounded-3xl shadow-2xl transform rotate-2">
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((_, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-4 bg-ink-800 p-4 rounded-xl"
                    >
      ...
      <section id="testimonios" className="py-24 bg-ink-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl lg:text-5xl font-display font-bold mb-6">
              Casos de Éxito de Negocios Latinos
            </h2>
            <p className="text-gray-400 text-lg">
              Dueños de negocios como tú que ya están viendo resultados reales.
            </p>
          </div>
            ...
            {[
              {
                ...
                quote:
                  "Antes dependía de que mis amigos me recomendaran para tener trabajo. Ahora mi teléfono suena todas las semanas con clientes nuevos gracias a los anuncios en Facebook.",
              },
              {
                name: "Roberto G.",
                business: "Contratista de Construcción",
                quote:
                  "No entendía nada de marketing, pero ellos me explicaron todo fácil. Mi compañía ahora se ve súper profesional en internet y cerramos contratos mucho más grandes.",
              },
              {
                name: "Maria S.",
                business: "Dueña de Salón de Belleza",
                quote:
                  "Las campañas y el manejo de redes cambiaron mi salón. Antes tenía días vacíos, ahora siempre tengo la agenda llena con semanas de anticipación.",
              },
            ].map((testimonial, i) => (
              <div
                key={i}
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              Resolvemos tus dudas de forma clara y directa.
            </p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-xl text-ink-900/80 font-medium mb-12 max-w-2xl mx-auto">
            No dejes pasar más tiempo. Toma acción hoy y asegura el futuro de tu
      ...
      <footer className="bg-ink-900 border-t border-white/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Impulso Latino. Agencia de Marketing
            Digital en USA. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </div>
